...
/**
 *
 * @param m (output) Message with public key appended
 * @param sm (input) 64byte signature (R,s), with message appended
 * @param n (input) Byte length of message
 * @param pk (input) Public key of signer
 * @returns
 */
