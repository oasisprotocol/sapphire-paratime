...
import {
	sapphireLocalnet,
	createSapphireConfig, injectedWithSapphire,
} from "@oasisprotocol/sapphire-wagmi-v2";
import {createConnector, http} from "wagmi";
import { walletConnectWithSapphire } from '@oasisprotocol/sapphire-wagmi-v2';
import { connectorsForWallets, getDefaultConfig, Wallet } from '@rainbow-me/rainbowkit';
...
import {metaMask, type WalletConnectParameters } from "wagmi/connectors";
import {
	...
	[
		{
			...
			wallets: [
				...
				// wrappedMetaMaskWallet,
				sapphireWalletConnectWallet()
			],
		},
	],
	{
		appName: 'My RainbowKit App',
		projectId: '92fd8c36de7a5e1c7b4f355e9f10268c',
	}
);
