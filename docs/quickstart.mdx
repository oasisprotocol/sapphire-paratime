...
![code typescript](../examples/hardhat/hardhat.config.ts#config-import)
...
Next, let's add the Sapphire testnet network to the network property of
HardhatUserConfig.

![code typescript](../examples/hardhat/hardhat.config.ts#config-networks)
...
3. Add deploy and check tasks to Hardhat config:

<details>
  <summary> hardhat.config.ts </summary>

  ![code typescript](../examples/hardhat/hardhat.config.ts#config-tasks)
</details>
