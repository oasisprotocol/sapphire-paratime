...
{/* -- https://github.com/oasisprotocol/docs/blob/main/docs/general/images/architecture/client-km-compute.svg --> */}
...
are exactly like Ethereum. Data contained in events is _not_ encrypted.
